...
#
RUN git clone -b master https://github.com/zkyzzz/zkyzzzwhatsappbot /home/wabot
WORKDIR /home/wabot
RUN wget https://raw.githubusercontent.com/zkyzzz/zkyzzzwhatsappbot/master/sessions/session.data.json
